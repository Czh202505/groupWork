<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registration.aspx.cs" Inherits="Pages_login" %>
    ...
    <div class="container">
        ...
        <div class="right-panel">
            <div class="login-header">
                ...
                <asp:Button ID="Button1" runat="server" Text="注册" CssClass="btn-login" OnClick="Button1_Click" />
            <div class="register-link">
                <p>已有账号？ <a href="login.aspx">去登录</a></p>
            </div>
